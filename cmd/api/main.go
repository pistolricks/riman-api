...
func main() {
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@github.com/pistolricks/riman-api>", "SMTP sender")
	...
	app := &application{
		...
		security: security.NewAPIClient(security.NewConfiguration()),
