...
type RmaSendSummaryInfoModel struct {
	ReturnAdress        string    `json:"returnAdress,omitempty"`
	ReturnLabel         string    `json:"returnLabel,omitempty"`
	QualityReturnAdress string    `json:"qualityReturnAdress,omitempty"`
	QualityCaseToFollow string    `json:"qualityCaseToFollow,omitempty"`
	IsEmailPreview      bool      `json:"isEmailPreview,omitempty"`
